...
<head>
    ...
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/bootstrap.bundle.js"></script>
    <!--    <script type="text/javascript" src="--><?php //echo ROOT_PATH; ?><!--js/popper.min.js"></script>-->
...
<div id="container">
    ...
    ?>
    <div id="header">
        <ul id="info" style="display: flex" class="nav justify-content-end pull-right no-pjax">
            <li class="" style="padding-top: 7px">
                <?php echo sprintf(__('Welcome, %s.'), '<strong>' . $thisstaff->getFirstName() . '</strong>'); ?>
            </li>
            <?php
            if ($thisstaff->isAdmin() && !defined('ADMINPAGE')) { ?>
                <li class="nav-item"><a  href="<?php echo ROOT_PATH ?>scp/admin.php"
                                        class="nav-link no-pjax"><?php echo __('Admin Panel'); ?></a></li>
            <?php } else { ?>
                <li class="nav-item"><a  href="<?php echo ROOT_PATH ?>scp/index.php"
                                        class="nav-link no-pjax"><?php echo __('Agent Panel'); ?></a></li>
            <?php } ?>
            <li class="nav-item"><a class="nav-link"
                                    href="<?php echo ROOT_PATH ?>scp/profile.php"><?php echo __('Profile'); ?></a></li>
            <li class="nav-item"><a class="nav-link"
                                    href="<?php echo ROOT_PATH ?>scp/logout.php?auth=<?php echo $ost->getLinkToken(); ?>"
