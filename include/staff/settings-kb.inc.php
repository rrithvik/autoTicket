...
<table class="table form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <input class="form-check-input" type="checkbox" name="enable_kb" value="1" <?php echo $config['enable_kb']?'checked="checked"':''; ?>>
                ...
                <input class="form-check-input" type="checkbox" name="restrict_kb" value="1" <?php echo $config['restrict_kb']?'checked="checked"':''; ?> >
        ...
        <tr>
            ...
            <td>
                <input class="form-check-input" type="checkbox" name="enable_premade" value="1" <?php echo $config['enable_premade']?'checked="checked"':''; ?> >
