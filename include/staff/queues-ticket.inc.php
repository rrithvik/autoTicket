<div>
    <div class="pull-right">
        <div style="display: flex">
            <a href="queues.php?t=tickets&amp;a=add" class="btn btn-success green button"><i
                        class="icon-plus-sign"></i> <?php echo __('Add New Queue'); ?></a>
            <div class="dropdown anchor-right">
                ...
                <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                    ...
                    <li>
                        <a class="nav-link queue-action no-pjax" data-action="enable" href="#queues.php">
                            <i class="icon-ok-sign icon-fixed-width"></i>
                            <?php echo __('Enable'); ?>
                        </a>
                    </li>
                    <li>
                        <a class="nav-link queue-action no-pjax" data-action="disable" href="#queues.php">
                            <i class="icon-ban-circle icon-fixed-width"></i>
                            <?php echo __('Disable'); ?>
                        </a>
                    </li>
                    <li class="danger">
                        <a class="nav-link queue-action no-pjax" data-action="delete" href="#queues.php">
...
<div class="clear"></div>
<?php csrf_token(); ?>
<table class="table list" border="0" cellspacing="1" cellpadding="0" width="940">
    <thead>
    <tr>
        <th width="3%">&nbsp;</th>
