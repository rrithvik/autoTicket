...
<form action="canned.php" method="POST" name="canned">
        ...
        <div class="content">
            ...
            <div class="pull-right flush-right">
                <div style="display: flex">
                    <a href="canned.php?a=add" class="btn btn-success green button"><i
                                class="icon-plus-sign"></i> <?php echo __('Add New Response'); ?></a>
                    ...
                    <i class="icon-cog"></i> <?php echo __('More'); ?></span>
                        <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                            ...
                            <li>
                                <a class="nav-link confirm" data-name="enable" href="canned.php?a=enable">
                                    <i class="icon-ok-sign icon-fixed-width"></i>
                                    <?php echo __('Enable'); ?>
                                </a>
                            </li>
                            <li>
                                <a class="nav-link confirm" data-name="disable" href="canned.php?a=disable">
                                    <i class="icon-ban-circle icon-fixed-width"></i>
                                    <?php echo __('Disable'); ?>
                                </a>
                            </li>
                            <li class="danger">
                                <a class="nav-link confirm" data-name="delete" href="canned.php?a=delete">
    ...
    <table class="table" border="0" cellspacing="1" cellpadding="0" width="940">
        ...
        <tr>
            <th width="4%">&nbsp;</th>
            <th width="46%"><a <?php echo $title_sort; ?>
                        href="canned.php?<?php echo $qstr; ?>&sort=title"><?php echo __('Title'); ?></a></th>
            <th width="10%"><a <?php echo $status_sort; ?>
                        href="canned.php?<?php echo $qstr; ?>&sort=status"><?php echo __('Status'); ?></a></th>
            <th width="20%"><a <?php echo $dept_sort; ?>
                        href="canned.php?<?php echo $qstr; ?>&sort=dept"><?php echo __('Department'); ?></a></th>
            <th width="20%" nowrap><a
                    <?php echo $updated_sort; ?>href="canned.php?<?php echo $qstr; ?>&sort=updated"><?php echo __('Last Updated'); ?></a>
            </th>
        </tr>
        </thead>
        <tbody>
                ...
                <tr id="<?php echo $row['canned_id']; ?>">
                    <td align="center">
                        <input class="form-check-input" type="checkbox" name="ids[]"
                               value="<?php echo $row['canned_id']; ?>" class="ckb"
