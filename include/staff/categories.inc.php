...
<form action="categories.php" method="POST" id="mass-actions">
    <div class="sticky bar opaque">
        <div class="content">
            ...
            <div class="pull-right flush-right">
                <div style="display: flex">
                    <a href="categories.php?a=add" class="btn btn-success green button">
                    ...
                    <span class="btn btn-secondary">                        <i class="icon-caret-down pull-right"
        ...
        <table class="table" border="0" cellspacing="1" cellpadding="0" width="940">
            ...
            <tr>
                <th width="4%">&nbsp;</th>
                <th width="56%"><a <?php echo $name_sort; ?>
                            href="categories.php?<?php echo $qstr; ?>&sort=name"><?php echo __('Name'); ?></a></th>
                <th width="10%"><a <?php echo $type_sort; ?>
                            href="categories.php?<?php echo $qstr; ?>&sort=type"><?php echo __('Type'); ?></a></th>
                <th width="10%"><a <?php echo $faqs_sort; ?>
                            href="categories.php?<?php echo $qstr; ?>&sort=faqs"><?php echo __('FAQs'); ?></a></th>
                <th width="20%" nowrap><a
                        <?php echo $updated_sort; ?>href="categories.php?<?php echo $qstr; ?>&sort=updated"><?php echo __('Last Updated'); ?></a>
                </th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr id="<?php echo $C->getId(); ?>">
                <td align="center">
                    <input class="form-check-input" type="checkbox" name="ids[]" value="<?php echo $C->getId(); ?>"
                           class="ckb"
