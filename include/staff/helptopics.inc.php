        ...
        <div class="content">
            ...
            <div class="pull-right flush-right">
                <div style="display: flex">
                    ...
                    <?php } ?>
                    <a href="helptopics.php?a=add" class="btn btn-success green button"><i class="icon-plus-sign"></i>
                        <?php echo __('Add New Help Topic'); ?></a>
                    ...
                    <i class="icon-caret-down pull-right" style="padding-top: 4px"></i>
                        ...
                        <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                            ...
                            <li class="dropdown-item">
                                <a class="nav-link confirm" data-name="disable" href="helptopics.php?a=disable">
                                    <i class="icon-ban-circle icon-fixed-width"></i>
                                    <?php echo __('Disable'); ?>
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a class="nav-link confirm" data-name="archive" href="helptopics.php?a=archive">
                                    <i class="icon-folder-close icon-fixed-width"></i>
                                    <?php echo __('Archive'); ?>
                                </a>
                            </li>
                            <li class="dropdown-item danger">
                                <a class="nav-link confirm" data-name="delete" href="helptopics.php?a=delete">
