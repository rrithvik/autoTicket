...
<div id="basic_search">
    <div style="height:fit-content; display: flex">
        <div class="container" id='filter'>
            <form class="row" style="position: static" action="logs.php" method="get">
                <div style="padding-left:2px; display: flex">
                    <i class="col-auto help-tip icon-question-sign" href="#date_span"></i>&nbsp;&nbsp;
                    <label class="col-auto col-form-label" for="sd"><?php echo __('Between'); ?>:</label>&nbsp;&nbsp;
                    <div class="col-auto" style="position: static">
                        <div class="input-group date" id="datepicker">
                            <input class="dp" id="sd" size=15 name="startDate"
                                   value="<?php echo Format::htmlchars($_REQUEST['startDate']); ?>" autocomplete="off">
                            ...
                            <!--                            </span>-->
                            &nbsp;&nbsp;
                            <input class="dp" id="ed" size=15 name="endDate"
                                   value="<?php echo Format::htmlchars($_REQUEST['endDate']); ?>" autocomplete="off">
                            &nbsp;
                        </div>

                    </div>
                    <div class="col-auto" style="position: static">
                        <?php echo __('Log Level'); ?>:&nbsp;<i class="help-tip icon-question-sign"
                                                                href="#type"></i>
                        &nbsp;&nbsp;
                    <select name='type'>
                        ...
                        &nbsp;&nbsp;</div>
                    <input class="btn  btn-secondary col-auto" type="submit" Value="<?php echo __('Go!'); ?>"/>
...
<form action="logs.php" method="POST" name="logs">
        ...
        <div class="sticky bar opaque">
            <div class="content">
                ...
                <div id="actions" class="pull-right flush-right">
                    <button class="btn btn-danger red button" type="submit" name="delete"><i class="icon-trash"></i>
    ...
    <table class="table" border="0" cellspacing="1" cellpadding="0" width="940">
        ...
        <tr>
            <th width="4%">&nbsp;</th>
            <th width="40%"><a class="nav-link" <?php echo $title_sort; ?>
                               href="logs.php?<?php echo $qstr; ?>&sort=title"><?php echo __('Log Title'); ?></a></th>
            <th width="11%"><a class="nav-link" <?php echo $type_sort; ?>
                               href="logs.php?<?php echo $qstr; ?>&sort=type"><?php echo __('Log Type'); ?></a></th>
            <th width="30%" nowrap><a class="nav-link"
                                      <?php echo $date_sort; ?>href="logs.php?<?php echo $qstr; ?>&sort=date"><?php echo __('Log Date'); ?></a>
            </th>
            <th width="15%"><a class="nav-link" <?php echo $ip_sort; ?>
                               href="logs.php?<?php echo $qstr; ?>&sort=ip"><?php echo __('IP Address'); ?></a></th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        if ($res && db_num_rows($res)):
            while ($row = db_fetch_array($res)) {
                ...
                <tr id="<?php echo $row['log_id']; ?>">
                    ...
                    <td>&nbsp;<a class="tip"
                                 href="#log/<?php echo $row['log_id']; ?>"><?php echo Format::htmlchars($row['title']); ?></a>
                    </td>
