            ...
            <form id="kbSearch" action="kb.php" method="get">
                ...
                <div id="">
                    <div class="attached input">
                        ...
                        <button class="btn btn-secondary button" id="searchSubmit" type="submit">
                            <i class="icon icon-search"></i>
                        </button>
                    </div>

                    <div class="pull-right" style="display: flex">
                        <div id="categoryDropdown" class="dropdown anchor-right">
                ...
                <i class="icon-caret-down pull-right" style="padding-top: 4px"></i>
                    ...
                    <?php echo __('Category'); ?>
                        ...
                        <div id="helpTopicDropdown" class="dropdown anchor-right">
&nbsp;
                            <span class="btn btn-primary">
                <i class="icon-caret-down pull-right" style="padding-top: 4px"></i>
                    <i class="icon-filter"></i>
