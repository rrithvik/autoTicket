...
<form method="post" action="dashboard.php">
    <div id="basic_search">
        <div style="min-height:25px;">
            ...
            <label>
                ...
                <select class="form-select d-inline-block" name="period">
                    <?php foreach ($report::$end_choices as $val => $desc)
                        echo "<option value='$val'>" . __($desc) . "</option>"; ?>
                </select>
            <button class="btn btn-success green button muted" type="submit">
                <?php echo __('Refresh'); ?>
            </button>
    ...
    foreach ($groups as $g => $desc) {
        ...
        <div class="tab_content <?php echo (!$first) ? 'hidden' : ''; ?>" id="<?php echo Format::slugify($g); ?>">
            <table class="table dashboard-stats">
                <tbody>
                <tr>
                    <?php
            ...
            <div style="margin-top: 5px">
                <button type="submit" class="link button" name="export"
