...
<div>
    ...
    <div class="sticky bar">
        <div class="content">
            <div class="pull-right flush-right" style="display: flex">
                <?php
                ...
                <div id="action-dropdown-print" class="dropdown anchor-right" style="display:flex;">

            <span class="btn btn-secondary" style="display: flex">
                <a class="nav-link" id="ticket-print" aria-label="<?php echo __('Print'); ?>"
                ...
                <i class="icon-caret-down pull-right" style="padding-top: 4px"></i>
                    ...
                    <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                        ...
                        <li title="PDF File"><a class="no-pjax" target="_blank"
                                        ...
                                        class="icon-file-text-alt"></i> <?php echo __('Thread + Internal Notes + Events'); ?>
                            </a>
                            <?php if (extension_loaded('zip')) { ?>
                        <li title="ZIP Archive"><a class="no-pjax" target="_blank"
                                                   href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=zip&notes=1"><i
                                        class="icon-folder-close-alt"></i> <?php echo __('Thread + Internal Notes + Attachments'); ?>
                            </a>
                        <li title="ZIP Archive"><a class="no-pjax" target="_blank"
                                                   href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=zip&notes=1&tasks=1"><i
                                        class="icon-folder-close-alt"></i> <?php echo __('Thread + Internal Notes + Attachments + Tasks'); ?>
                            </a>
                            <?php } ?>
                    </ul>
                </div>
            ...
            >
                <a class="nav-link ticket-action" id="ticket-assign"
                   data-redirect="tickets.php"
                ...
                <i class="icon-caret-down pull-right" style="padding-top: 4px"></i>
                        ...
                        <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                            ...
                            <li><a class="nav-link no-pjax ticket-action"
                ...
                <div id="action-dropdown-more" class="anchor-right">
                    <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                        <?php
                        if ($role->hasPerm(Ticket::PERM_EDIT)) { ?>
                            <li><a class="nav-linkchange-user" href="#tickets/<?php
                        ...
                        if ($role->hasPerm(Ticket::PERM_MERGE) && !$ticket->isChild()) { ?>
                            <li><a class="nav-link" href="#ajax.php/tickets/<?php echo $ticket->getId();
                        ...
                        if ($ticket->isAssigned() && $canRelease) { ?>
                            <li><a href="#tickets/<?php echo $ticket->getId();
                                ?>/release" class="nav-link ticket-action"
                        ...
                        if ($ticket->isOpen() && $isManager) {
                            if (!$ticket->isOverdue()) { ?>
                                <li><a class="nav-link confirm-action" id="ticket-overdue" href="#overdue"><i
                        ...
                        if ($ticket->isOpen() && $canMarkAnswered) {
                            if ($ticket->isAnswered()) { ?>
                                <li><a href="#tickets/<?php echo $ticket->getId();
                                    ?>/mark/unanswered" class="nav-link ticket-action"
                                       data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>">
                                ...
                                <li><a href="#tickets/<?php echo $ticket->getId();
                                    ?>/mark/answered" class="nav-link ticket-action"
                                       data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>">
                        ...
                        if ($role->hasPerm(Ticket::PERM_REFER)) { ?>
                            <li><a href="#tickets/<?php echo $ticket->getId();
                                ?>/referrals" class="nav-link ticket-action"
                                   data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>">
                    ...
                    return false"
                        ...
                        if ($role->hasPerm(Ticket::PERM_REPLY) && $thread && $ticket->getId() == $thread->getObjectId()) {
                            ...
                            <li>
                                ...
                                echo sprintf('<a class="nav-link collaborators manage-collaborators"
                        ...
                        <?php if ($thisstaff->hasPerm(Email::PERM_BANLIST)
                            ...
                            if (!$emailBanned) { ?>
                                <li><a class="nav-link   confirm-action" id="ticket-banemail"
                        ...
                        if ($role->hasPerm(Ticket::PERM_DELETE)) {
                            ?>
                            <li class="danger"><a class="nav-link ticket-action" href="#tickets/<?php
            ...
            <div class="flush-left">
                <h2><a class="nav-link" href="tickets.php?id=<?php echo $ticket->getId(); ?>"
        ...
        <td width="50%">
            <table border="0" cellspacing="0" cellpadding="4" width="100%">
                ...
                <tr>
                    ...
                    if ($role->hasPerm(Ticket::PERM_TRANSFER)) { ?>
                        <td>
                            <a class="ticket-action" data-placement="bottom" data-toggle="tooltip"
                               title="<?php echo __('aTransfer'); ?>"
                               data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>"
                ...
                <tr>
                    ...
                    <td><a href="#tickets/<?php echo $ticket->getId(); ?>/user"
                        ...
                        if ($user) { ?>
                            ...
                            <div id="action-dropdown-stats" class="dropdown-menu action-dropdown anchor-right">
                                <ul>
                                    <?php
                ...
                <?php if ($user->getOrganization()) { ?>
                    <tr>
                        ...
                        <td><i class="icon-building"></i>
                            ...
                            <div id="action-dropdown-org-stats" class="dropdown-menu action-dropdown anchor-right">
                                <ul>
                    ...
                    <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
                                            ...
                                            <ul>
                                                ...
                                                <li><a class="manage-collaborators"
                                                       ...
                                                       $ticket->getThreadId(); ?>/collaborators/1"><i
                                                                class="icon-cog"></i> <?php echo __('Manage Collaborators'); ?>
                                                    </a>
                                            </ul>
                                        </div>
                                        <?php
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <label><input class="form-check-input" type="radio" name="signature" value="none"
