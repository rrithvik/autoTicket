...
<form action="pages.php" method="POST" name="tpls">
        ...
        <div class="content">
            ...
            <div class="pull-right flush-right">
                <div style="display: flex">
                    <a href="pages.php?a=add" class="btn btn-success green button"><i
                                class="icon-plus-sign"></i> <?php echo __('Add New Page'); ?></a>
            ...
            <i class="icon-cog"></i> <?php echo __('More'); ?></span>
                    ...
                    <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                        ...
                        <li>
                            <a class="nav-link confirm" data-name="enable" href="pages.php?a=enable">
                                <i class="icon-ok-sign icon-fixed-width"></i>
                                <?php echo __('Enable'); ?>
                            </a>
                        </li>
                        <li>
                            <a class="nav-link confirm" data-name="disable" href="pages.php?a=disable">
                                <i class="icon-ban-circle icon-fixed-width"></i>
                                <?php echo __('Disable'); ?>
                            </a>
                        </li>
                        <li class="danger">
                            <a class="nav-link confirm" data-name="delete" href="pages.php?a=delete">
    ...
    <form action="pages.php" method="POST" name="tpls">
        ...
        <table class="table" border="0" cellspacing="1" cellpadding="0" width="940">
            ...
            <tr>
                <th width="4%">&nbsp;</th>
                <th width="35%"><a <?php echo $name_sort; ?>
                            href="pages.php?<?php echo $qstr; ?>&sort=name"><?php echo __('Name'); ?></a></th>
                <th width="10%"><a <?php echo $type_sort; ?>
                            href="pages.php?<?php echo $qstr; ?>&sort=type"><?php echo __('Type'); ?></a></th>
                <th width="16%"><a <?php echo $status_sort; ?>
                            href="pages.php?<?php echo $qstr; ?>&sort=status"><?php echo __('Status'); ?></a></th>
                <th width="15%" nowrap><a
                        <?php echo $created_sort; ?>href="pages.php?<?php echo $qstr; ?>&sort=created"><?php echo __('Date Added'); ?></a>
                </th>
                <th width="20%" nowrap><a
                        <?php echo $updated_sort; ?>href="pages.php?<?php echo $qstr; ?>&sort=updated"><?php echo __('Last Updated'); ?></a>
                </th>
            </tr>
            </thead>
            <tbody>
            ...
            foreach ($pages as $page) {
                ...
                <tr id="<?php echo $page->id; ?>">
                    ...
                    <td>&nbsp;<a
                                href="pages.php?id=<?php echo $page->id; ?>"><?php echo Format::htmlchars($page->getLocalName() ?: $page->getName()); ?></a>
                    </td>
