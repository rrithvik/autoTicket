...
<form action="banlist.php" method="POST" name="banlist">
    <div style="margin-bottom:20px; padding-top:5px;">
            ...
            <div class="content">
                ...
                <div class="pull-right flush-right">
                    <div style="display: flex">
                        <div id='' style="height:fit-content">
                            <div style="height:fit-content">
                                <form action="banlist.php" method="GET" name="filter">
                                    <input class="form-control" type="hidden" name="a" value="filter">
                                    <div class="attached input">
                                        <input name="q" style="height: inherit" type="text" class="basic-search"
                        ...
                        <a href="banlist.php?a=add" class="btn btn-danger red button">
                    ...
                    <i class="icon-cog"></i> <?php echo __('More'); ?></span>
                            <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                                ...
                                <li><a class="nav-link confirm" data-name="enable" href="banlist.php?a=enable">
                                        <i class="icon-ok-sign icon-fixed-width"></i>
                                        <?php echo __('Enable'); ?></a></li>
                                <li><a class="nav-link confirm" data-name="disable" href="banlist.php?a=disable">
                                        <i class="icon-ban-circle icon-fixed-width"></i>
                                        <?php echo __('Disable'); ?></a></li>
                                <li><a class="nav-link confirm" data-name="delete" href="banlist.php?a=delete"> <i
                                                class="icon-undo icon-fixed-width"></i>
        ...
        <table class="table" border="0" cellspacing="1" cellpadding="0" width="940">
            ...
            <tr>
                <th width="4%">&nbsp;</th>
                <th width="56%"><a <?php echo $email_sort; ?>
                            href="banlist.php?<?php echo $qstr; ?>&sort=email"><?php echo __('Email Address'); ?></a>
                </th>
                <th width="10%"><a <?php echo $status_sort; ?>
                            href="banlist.php?<?php echo $qstr; ?>&sort=status"><?php echo __('Ban Status'); ?></a></th>
                <th width="10%"><a <?php echo $created_sort; ?>
                            href="banlist.php?<?php echo $qstr; ?>&sort=created"><?php echo __('Date Added'); ?></a>
                </th>
                <th width="20%"><a <?php echo $updated_sort; ?>
                            href="banlist.php?<?php echo $qstr; ?>&sort=updated"><?php echo __('Last Updated'); ?></a>
                </th>
            </tr>
            </thead>
            <tbody>
            ...
            if ($res && db_num_rows($res)):
                ...
                while ($row = db_fetch_array($res)) {
                    ...
                    <tr id="<?php echo $row['id']; ?>">
                        ...
                        <td>&nbsp;<a
                                    href="banlist.php?id=<?php echo $row['id']; ?>"><?php echo Format::htmlchars($row['val']); ?></a>
                        </td>
                        <td>
                            &nbsp;&nbsp;<?php echo $row['isactive'] ? __('Active') : '<b>' . __('Disabled') . '</b>'; ?></td>
