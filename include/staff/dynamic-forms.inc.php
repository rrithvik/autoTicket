        ...
        <div class="content">
            ...
            <div class="pull-right flush-right">
                <div style="display: flex">
                    <a href="forms.php?a=add" class="btn btn-success green button"><i class="icon-plus-sign"></i> <?php
                    ...
                    <i class="icon-cog"></i> <?php echo __('More'); ?></span>
                        <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                            ...
                            <li class="danger">
                                <a class="nav-link confirm" data-name="delete" href="forms.php?a=delete">
