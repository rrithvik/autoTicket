            ...
            <div class="pull-right">
                <div style="display: flex">
                    <div style="min-height:25px;">
                        <div>
                            <form class="input-group" action="staff.php" method="GET" name="filter">
                                <input class="form-control d-inline-block" type="hidden" name="a" value="filter">
                    ...
                    <option value="%d" %s>%s</option>', $id, $sel, $name);
                                ...
                                <select class="form-select d-inline-block" name="tid" id="tid">
                                    <option value="0">&mdash;
                                        <?php echo __('All Teams'); ?> &mdash;
                                    </option>
                    ...
                    <option value="%d" %s>%s</option>', $id, $sel, $name);
                                ...
                                <input class="btn btn-primary" type="submit" name="submit" class="button muted"
                                       value="<?php echo __('Apply'); ?>"/>
                            </form>
                        </div>
                    </div>&nbsp;&nbsp;
                    <a class="btn btn-success green button" href="staff.php?a=add">
                ...
                <i class="icon-cog"></i> <?php echo __('More'); ?></span>
                        <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                            ...
                            <li>
                                <a class="nav-link confirm" data-form-id="mass-actions" data-name="enable"
                                   href="staff.php?a=enable">
                                    <i class="icon-ok-sign icon-fixed-width"></i>
                                    <?php echo __('Enable'); ?>
                                </a>
                            </li>
                            <li>
                                <a class="nav-link confirm" data-form-id="mass-actions" data-name="disable"
                                   href="staff.php?a=disable">
                                    <i class="icon-ban-circle icon-fixed-width"></i>
                                    <?php echo __('Disable'); ?>
                                </a>
                            </li>
                            <li>
                                <a class="nav-link dialog-first" data-action="permissions"
                                   href="#staff/reset-permissions">
                                    <i class="icon-sitemap icon-fixed-width"></i>
                                    <?php echo __('Reset Permissions'); ?>
                                </a>
                            </li>
                            <li>
                                <a class="nav-link dialog-first" data-action="department"
                                   href="#staff/change-department">
                                    <i class="icon-truck icon-fixed-width"></i>
                                    <?php echo __('Change Department'); ?>
                                </a>
                            </li>
                            <li>
                                <a class="nav-link no-pjax" href="staff.php?a=export">
                                    <i class="icon-download-alt icon-fixed-width"></i>
                                    <?php echo __('Export Agents'); ?>
                                </a>
                            </li>
                            <!-- TODO: Implement "Reset Access" mass action
                    <li><a class="nav-link dialog-first" href="#staff/reset-access">
                    <i class="icon-puzzle-piece icon-fixed-width"></i>
                        <?php echo __('Reset Access'); ?></a></li>
                    -->
                            <li class="danger">
                                <a class="nav-link confirm" data-form-id="mass-actions" data-name="delete"
                                   href="staff.php?a=delete">
...
<form id="mass-actions" action="staff.php" method="POST" name="staff">
    ...
    <table class="table" border="0" cellspacing="1" cellpadding="0" width="940">
        ...
        <tr>
            <th width="4%">&nbsp;</th>
            <th width="28%"><a <?php echo $name_sort; ?>
                        href="staff.php?<?php echo $qstr; ?>&sort=name"><?php echo __('Name'); ?></a></th>
            <th width="16%"><a <?php echo $username_sort; ?>
                        href="staff.php?<?php echo $qstr; ?>&sort=username"><?php echo __('Username'); ?></a></th>
            <th width="8%"><a <?php echo $status_sort; ?>
                        href="staff.php?<?php echo $qstr; ?>&sort=status"><?php echo __('Status'); ?></a></th>
            <th width="14%"><a
                    <?php echo $dept_sort; ?>href="staff.php?<?php echo $qstr; ?>&sort=dept"><?php echo __('Department'); ?></a>
            </th>
            <th width="14%"><a <?php echo $created_sort; ?>
                        href="staff.php?<?php echo $qstr; ?>&sort=created"><?php echo __('Created'); ?></a></th>
            <th width="16%"><a <?php echo $login_sort; ?>
                        href="staff.php?<?php echo $qstr; ?>&sort=login"><?php echo __('Last Login'); ?></a></th>
        </tr>
        </thead>
        <tbody>
        <?php
