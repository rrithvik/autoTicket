        ...
        <div class="content">
            ...
            <div class="pull-right">
                <div style="display: flex">
                    ...
                    <a class="btn btn-success green button add-org"
                       href="#">
                ...
                if ($thisstaff->hasPerm(Organization::PERM_DELETE)) { ?>
                    ...
                    <i class="icon-cog"></i> <?php echo __('More'); ?></span>
                        <ul class="dropdown-menu" id="actions" data-dropdown="#action-dropdown-more">
                            <li class="danger"><a class="nav-link orgs-action" href="#delete">
...
<form id="orgs-list" action="orgs.php" method="POST" name="staff">
    ...
    <table class="table" border="0" cellspacing="1" cellpadding="0" width="940">
        ...
        <tr>
            ...
            <th width="45%"><a <?php echo $name_sort; ?>
                        href="orgs.php?<?php echo $qstr; ?>&sort=name"><?php echo __('Name'); ?></a></th>
            <th width="11%"><a <?php echo $users_sort; ?>
                        href="orgs.php?<?php echo $qstr; ?>&sort=users"><?php echo __('Users'); ?></a></th>
            <th width="20%"><a <?php echo $create_sort; ?>
                        href="orgs.php?<?php echo $qstr; ?>&sort=create"><?php echo __('Created'); ?></a></th>
            <th width="20%"><a <?php echo $update_sort; ?>
                        href="orgs.php?<?php echo $qstr; ?>&sort=update"><?php echo __('Last Updated'); ?></a></th>
        </tr>
        </thead>
        <tbody>
        <?php
