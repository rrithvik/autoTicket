...
$(".dropdown").on('mouseover', function () {
    if ($(this)[0].hasAttribute('data-dropdown')) {
        var iid = $(this)[0].getAttribute('data-dropdown');
        var d_menu = $($(this)[0].getAttribute('data-dropdown'))[0];
        // console.log(iid)
        // d_menu.style.position = "table-column";
        if ($(this).find(iid).length) {
            console.log('exists')
            $(this)[0].getElementsByTagName('ul')[0].style.display = "block";
        } else {
            $(this)[0].appendChild(d_menu);

            $(this)[0].getElementsByTagName('ul')[0].style.display = "block";
            $(this)[0].getElementsByTagName('ul')[0].style.width = "fit-content";
            // $(this)[0].getElementsByTagName('ul')[0].style.whiteSpace = "nowrap";
            // d_menu.getElementsByTagName('ul')[0].style.left = 0;
            var e_id = $(this).find(iid)[0]
            if (e_id.nodeName === "DIV") {
                e_id.getElementsByTagName('ul')[0].onmouseover = function () {
                    this.style.display = 'block'
                };
                e_id.getElementsByTagName('ul')[0].onmouseout = function () {
                    this.style.display = 'none'
                };
            }
            if (e_id.nodeName === "UL") {
                e_id.onmouseover = function () {
                    this.style.display = 'block'
                };
                e_id.onmouseout = function () {
                    this.style.display = 'none'
                };
            }
            $(this).on('mouseout', function () {
                if (e_id.nodeName === "DIV") {
                    e_id.getElementsByTagName('ul')[0].style.display = 'none'
                }
                if (e_id.nodeName === "UL") {
...
//         // console.log(d_menu)
//         // d_menu.style.position = "table-column";
//         // $(this).find(iid)[0].style.display = "none";
//         if ($(this).find(iid).length) {
//
//             var e_id = $(this).find(iid)[0]
//         if (e_id.nodeName === "DIV") {
